...
/* 1)    var textCanvas = document.createElement("canvas");
   ...
   // tick();
    ...
    function createFireworks(x, y, text = "") {
        ...
        if (text != "") {
            ...
            var imageData = context.getImageData(x,y,textWidth,textHeight);

            //画完后变为黑色状态
            //2) textctx.fillRect(0,0,textCanvas.width,textCanvas.height);
            var gap = 2;
